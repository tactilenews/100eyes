class Contributors::IndexData
  ...
  attr_reader :organization, :state, :tag_list, :active_count, :inactive_count, :unsubscribed_count, :available_tags, :contributors, :filter_count
