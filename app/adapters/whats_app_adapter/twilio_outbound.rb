  ...
  class TwilioOutbound
    class << self
      ...
      def send_message_template!(recipient, message)
        ...
        WhatsAppAdapter::Outbound::Text.perform_later(organization_id: message.organization.id, contributor_id: recipient.id,
                                                      text: text)
      end
      ...
      def send_message(recipient, message)
        ...
        if files.blank?
          ...
          WhatsAppAdapter::Outbound::File.perform_later(organization_id: message.organization.id, contributor_id: recipient.id,
                                                        message: message)
        end
      end
    end
