  ...
  class TwilioOutbound
    class << self
      ...
      def send_welcome_message!(contributor)
        ...
        WhatsAppAdapter::TwilioOutbound::Text.perform_later(contributor_id: contributor.id,
      ...
      def send_unsupported_content_message!(contributor)
        ...
        WhatsAppAdapter::TwilioOutbound::Text.perform_later(contributor_id: contributor.id, text: text)
      end
      ...
      def send_message(recipient, message)
        ...
        if files.blank?
          WhatsAppAdapter::TwilioOutbound::Text.perform_later(contributor_id: recipient.id,
                                                              text: message.text, message: message)
        else
          WhatsAppAdapter::TwilioOutbound::File.perform_later(contributor_id: recipient.id,
                                                              message: message)
        end
      end
    end
