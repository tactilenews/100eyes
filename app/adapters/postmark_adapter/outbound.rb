...
module PostmarkAdapter
  class Outbound < ApplicationMailer
    ...
    def business_plan_upgraded_email
      ...
      mail(from: email_from_address(organization: organization), to: admin.email, subject: subject, message_stream: message_stream)
    end
    ...
    def email_from_address(organization:)
