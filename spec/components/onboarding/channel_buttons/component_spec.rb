...
RSpec.describe Onboarding::ChannelButtons::Component, type: :component do
  ...
  it { should_not have_css('.Onboarding-ChannelButtons--even') }
  ...
  context 'if Signal is set up' do
    ...
    it { should have_css('.Onboarding-ChannelButtons--even') }
  end
end
