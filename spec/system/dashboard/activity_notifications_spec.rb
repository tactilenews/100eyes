...
RSpec.describe 'Activity Notifications' do
  context 'with recent activity' do
    ...
    it 'displays the activity notifications on dashboard' do
      ...
      expect(page).to have_link('Zum Profil', href: organization_contributor_path(contributor.organization, contributor))
      ...
      reply_path = conversations_organization_contributor_path(contributor_without_avatar.organization_id, id: contributor_without_avatar, reply_to: reply.id, anchor: 'chat-form')
      ...
      expect(page).to have_current_path(conversations_organization_contributor_path(contributor_without_avatar.organization_id, contributor_without_avatar))
      ...
      reply_path = conversations_organization_contributor_path(contributor_two.organization, contributor_two, reply_to: reply_by_same_contributor.id, anchor: 'chat-form')
      expect(page).to have_selector("a[href='#{reply_path}']")
      find("a[href='#{reply_path}']", text: 'antworten').trigger('click')
      ...
      expect(page).to have_current_path(conversations_organization_contributor_path(contributor_two.organization, contributor_two))
